...
namespace InDoorMappingAPI.Controllers
{
    ...
    public class Caminhos2Controller : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Caminho2>>> GetAll()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Caminho2>> GetById(long id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Create(Caminho2 caminho)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> Update(long id, Caminho2 caminho)
        {
            if (id != caminho.Id)
